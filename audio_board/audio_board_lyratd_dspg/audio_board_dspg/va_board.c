...
esp_err_t va_board_button_init()
{
    ...
    ab_button_conf->va_button_adc_val[VA_BUTTON_CUSTOM_1] = 2000;
...
extern esp_err_t stm8_led_init();
//-------------------------------------------------------------
...
esp_err_t va_stm8_led_init()
{
    va_led_config_t *ab_led_conf = NULL;
    led_single_init(&ab_led_conf);
    stm8_led_init();
    va_led_init_stm8((va_led_config_t *)ab_led_conf);
    return ESP_OK;
}
//-------------------------------------------------------------